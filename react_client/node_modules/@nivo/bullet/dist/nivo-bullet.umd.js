(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nivo/core'), require('@react-spring/web'), require('react/jsx-runtime'), require('@nivo/tooltip'), require('react'), require('@nivo/axes'), require('@nivo/colors'), require('@nivo/scales')) :
  typeof define === 'function' && define.amd ? define(['exports', '@nivo/core', '@react-spring/web', 'react/jsx-runtime', '@nivo/tooltip', 'react', '@nivo/axes', '@nivo/colors', '@nivo/scales'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.nivo, global['@react-spring/web'], global['react/jsx-runtime'], global.nivo, global.React, global.nivo, global.nivo, global.nivo));
}(this, (function (exports, core, web, jsxRuntime, tooltip, React, axes, colors, scales) { 'use strict';
  ...
  var BulletMarkersItem = function BulletMarkersItem(_ref) {
    ...
    return jsxRuntime.jsx(web.animated.line, {
      transform: transform,
      x1: x,
      x2: x,
      y1: y1,
  ...
  var BulletTooltip = function BulletTooltip(_ref) {
    ...
    return jsxRuntime.jsx(tooltip.BasicTooltip, {
      id: v1 ? jsxRuntime.jsxs("span", {
        children: [jsxRuntime.jsx("strong", {
          children: v0
        }), " to ", jsxRuntime.jsx("strong", {
          children: v1
        })]
  ...
  var BulletMarkers = function BulletMarkers(_ref2) {
    ...
    var transition = web.useTransition(markers.map(function (marker) {
  ...
  var BulletRects = function BulletRects(_ref) {
    ...
    var transform = animatedProps ? web.to(animatedProps.measuresY, getTransform) : getTransform(y);

    var _useMotionConfig = core.useMotionConfig(),
        animate = _useMotionConfig.animate,
        springConfig = _useMotionConfig.config;

    var transition = web.useTransition(rects, {
    ...
    return jsxRuntime.jsx(web.animated.g, {
      ...
      children: transition(function (props, rect) {
        return React.createElement(component, {
          ...
          width: web.to(props.width, function (value) {
            return Math.max(value, 0);
          }).get(),
          height: web.to(props.height, function (value) {
            return Math.max(value, 0);
          }).get(),
  ...
  var BulletItem = function BulletItem(_ref) {
    ...
    var TooltipComponent = tooltip$1;

    var rangeNodes = jsxRuntime.jsx(BulletRects, {
      data: computedRanges,
      scale: scale,
      layout: layout,
      reverse: reverse,
      ...
      onMouseEnter: function onMouseEnter(range, event) {
        showTooltipFromEvent(jsxRuntime.jsx(TooltipComponent, {
          color: range.color,
          v0: range.v0,
          v1: range.v1
        }), event);
    ...
    var markerNodes = jsxRuntime.jsx(BulletMarkers, {
    ...
    var axis = jsxRuntime.jsx("g", {
      transform: "translate(".concat(axisX, ",").concat(axisY, ")"),
      children: jsxRuntime.jsx(axes.Axis, {
    ...
    var titleNode = jsxRuntime.jsx("g", {
      transform: "translate(".concat(titleX, ",").concat(titleY, ") rotate(").concat(titleRotation, ")"),
      children: typeof title === 'string' ? jsxRuntime.jsx("text", {
    ...
    return jsxRuntime.jsxs(web.animated.g, {
      ...
      children: [rangeNodes, jsxRuntime.jsx(BulletRects, {
  ...
  var useEnhancedData = function useEnhancedData(data, _ref) {
    ...
    return React.useMemo(function () {
      return data.map(function (d) {
        ...
        var scale = scales.createLinearScale({
          clamp: true,
          min: min,
          max: max,
          type: 'linear'
  ...
  var Bullet = function Bullet(props) {
    ...
    return jsxRuntime.jsx(core.Container, {
      ...
      children: jsxRuntime.jsx(core.SvgWrapper, {
        width: width,
        height: height,
        margin: margin,
        role: role,
        children: enhancedData.map(function (d, i) {
          return jsxRuntime.jsx(BulletItem, _objectSpread2(_objectSpread2({}, d), {}, {
            layout: layout,
            reverse: reverse,
    ...
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(Bullet, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
